...
const { registrarEntrada, validarLote, registrarSalida, registrarTraslado, getAreas, getClientes, entradaMovimiento, PromedioEntradas, PromedioSalidas } = require('../controllers/crud.controllers');
const router = Router();
